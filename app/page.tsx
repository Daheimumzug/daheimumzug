  ...
  return (
    <div style={{ marginBottom: 0 }}>
      <div style={{ fontSize: 10, fontWeight: 700, color: "rgba(255,255,255,0.38)", textTransform: "uppercase", letterSpacing: "0.15em", marginBottom: 7, display: "flex", justifyContent: "space-between" }}>
        <span>{label}</span>
        {!hidePrice && <span style={{ color: GOLD }}>+{priceEach} â‚¬ / St&uuml;ck</span>}
      </div>
...
export default function Home() {
  ...
  const handleSubmit = () => {
    ...
    const lines = [
      `*Neue Umzugsanfrage â€“ DaheimUmzug*`,
      ``,
      ...
      `&#x1F4CF; *Entfernung:* ${distMode === "address" && addrFrom && addrTo ? `${addrFrom} â†’ ${addrTo} (~${distance} km)` : `${distance} km`}`,
      disassemble > 0   ? `&#x1F527; *Schrank abbauen:* ${disassemble}x`         : "",
      assemble > 0      ? `&#x1F528; *Schrank aufbauen:* ${assemble}x`           : "",
      kitchenAbbau > 0  ? `&#x1F373; *K&uuml;che abbauen:* ${kitchenAbbau}x`         : "",
      kitchenAufbau     ? `&#x1F373; *K&uuml;che aufbauen:* Ja (Preis auf Anfrage)`  : "",
      `&#x1F4B6; *Sch&auml;tzpreis:* ${price} â‚¬`,
      ``,
  ...
  const services = [
    { icon: "&#x1F3E0;", title: "Privatumzug",  desc: "Vom Studio bis zur Villa â€” wir k&uuml;mmern uns um jeden Karton mit gr&ouml;&szlig;ter Sorgfalt.", price: "ab 280 â‚¬" },
    { icon: "&#x1F3E2;", title: "B&uuml;roumzug",    desc: "Schnelle, diskrete B&uuml;roverlagerungen â€” minimale Ausfallzeit f&uuml;r Ihr Unternehmen.", price: "auf Anfrage" },
    { icon: "&#x1F4E6;", title: "Einlagerung",  desc: "Sichere Zwischenlagerung Ihrer Gegenst&auml;nde â€” trocken, versichert, flexibel buchbar.", price: "ab 49 â‚¬ / Mo." },
    { icon: "&#x1F6CB;", title: "M&ouml;belmontage", desc: "Professionelles Auf- und Abbauen aller M&ouml;belst&uuml;cke â€” IKEA bis Ma&szlig;anfertigung.", price: "ab 50 â‚¬ / St&uuml;ck" },
    { icon: "&#x1F4CB;", title: "Verpackung",   desc: "Wir verpacken alles sicher â€” Spezialverpackung f&uuml;r Kunst, Glas und Elektronik.", price: "ab 80 â‚¬" },
    { icon: "&#x1F69B;", title: "Fernumzug",    desc: "Deutschlandweit und europaweit â€” mit Vollkasko-Versicherung und GPS-Tracking.", price: "auf Anfrage" },
  ];

  const faqs = [
    { q: "Wie weit im Voraus soll ich buchen?", a: "Wir empfehlen mindestens 2â€“3 Wochen vor dem gew&uuml;nschten Umzugstermin. In der Hochsaison (Maiâ€“September) idealerweise 4â€“6 Wochen." },
    { q: "Ist mein Umzugsgut versichert?", a: "Ja, jeder Umzug ist standardm&auml;&szlig;ig mit einer Transportversicherung bis 50.000 â‚¬ abgedeckt. Auf Wunsch bieten wir auch h&ouml;here Deckungssummen an." },
    { q: "Kann ich den Termin kurzfristig &auml;ndern?", a: "Termin&auml;nderungen sind bis 48 Stunden vorher kostenlos m&ouml;glich. Danach berechnen wir eine kleine Bearbeitungsgeb&uuml;hr." },
    { q: "Liefert ihr auch Verpackungsmaterial?", a: "Selbstverst&auml;ndlich! Kartons, Luftpolsterfolie, Klebeband und Schutzdecken liefern wir auf Wunsch vorab zu Ihnen nach Hause." },
    ...
    { q: "Wie genau ist der Preisrechner?", a: "Der Rechner gibt eine solide Sch&auml;tzung f&uuml;r Standardumz&uuml;ge. F&uuml;r eine verbindliche Offerte kommen wir gerne kostenlos zu Ihnen." },
  ];
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: NAVY, color: "#fff", overflowX: "hidden" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .lift:hover { transform:translateY(-8px); box-shadow:0 28px 56px rgba(0,0,0,.28); }
        ...
        .gold-btn {
          display:block; width:100%; background:${GOLD}; color:#fff;
          padding:16px; border-radius:14px; border:none; font-size:14px;
          font-weight:700; cursor:pointer; transition:all .22s; font-family:inherit;
        ...
        @media (min-width:769px) and (max-width:1024px) {
          ...
          .testim-grid { grid-template-columns:1fr 1fr !important; }
      ...
      {/* WHATSAPP FLOATING */}
      <a
        href="https://wa.me/49000000000?text=Hallo%2C%20ich%20m%C3%B6chte%20einen%20Umzug%20anfragen."
      ...
      <nav style={{ position:"fixed", top:0, left:0, right:0, zIndex:100, background:scrolled?"rgba(11,31,58,.95)":"transparent", backdropFilter:scrolled?"blur(18px)":"none", borderBottom:scrolled?"1px solid rgba(176,137,104,.1)":"none", transition:"all .35s", padding:"0 24px" }}>
        <div style={{ maxWidth:1200, margin:"0 auto", height:68, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
          <button type="button" onClick={() => scrollTo("hero")}
            ...
            <div style={{ width:36, height:36, borderRadius:8, background:GOLD, display:"flex", alignItems:"center", justifyContent:"center", fontSize:18, fontWeight:900, color:NAVY, fontFamily:"'Playfair Display', serif", fontStyle:"italic" }}>D</div>
      ...
      <section id="hero" ref={heroRef as React.RefObject<HTMLElement>} style={{ position:"relative", minHeight:"100svh", display:"flex", alignItems:"center", justifyContent:"center", overflow:"hidden" }}>
        ...
        <div style={{ position:"relative", zIndex:10, textAlign:"center", padding:"100px 24px 60px", maxWidth:860, width:"100%" }}>
          <div className="gpulse" style={{ display:"inline-block", background:"rgba(176,137,104,.12)", border:"1px solid rgba(176,137,104,.35)", color:GOLD, fontSize:10, fontWeight:700, padding:"6px 18px", borderRadius:999, letterSpacing:"0.22em", textTransform:"uppercase", marginBottom:28 }}>
            âœ¦ Premium Umzugsservice Â· Baden-W&uuml;rttemberg
          </div>
          ...
          <p className={`fu ${heroVisible?"on":""} d3`} style={{ fontSize:"clamp(15px,2vw,18px)", color:"rgba(255,255,255,.6)", fontWeight:300, lineHeight:1.75, maxWidth:540, margin:"0 auto 36px" }}>
            Ihr Partner f&uuml;r stressfreie Umz&uuml;ge â€” von der Planung bis zum letzten Karton.{" "}
      ...
      <div style={{ background:DARK, borderBottom:"1px solid rgba(176,137,104,.1)", padding:"18px 24px" }}>
        <div className="trust-bar" style={{ maxWidth:1000, margin:"0 auto" }}>
          {[
            { icon:"&#x1F6E1;", label:"Vollkasko-Versicherung", sub:"bis 50.000 â‚¬ gedeckt" },
            { icon:"&#x2705;", label:"Gepr&uuml;ftes Unternehmen",  sub:"seit 2016 aktiv" },
            { icon:"&#x1F550;", label:"24h Antwortgarantie",    sub:"schnelle R&uuml;ckmeldung" },
            { icon:"&#x1F4B6;", label:"Keine Anzahlung",        sub:"Zahlung erst nach Umzug" },
          ].map((b,i) => (
      ...
      <section ref={statsRef as React.RefObject<HTMLElement>} style={{ background:GOLD, padding:"32px 24px" }}>
        <div className="stats-grid" style={{ maxWidth:960, margin:"0 auto", display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:16, textAlign:"center" }}>
          {[{n:1200,s:"+",label:"Umz&uuml;ge"},{n:8,s:" J.",label:"Erfahrung"},{n:15,s:"",label:"Profis"},{n:4.9,s:"â˜…",label:"Bewertung"}].map((item,i) => (
        ...
        <div className="about-grid" style={{ maxWidth:1100, margin:"0 auto", display:"grid", gridTemplateColumns:"1fr 1fr", gap:72, alignItems:"center" }}>
          <div className={`fu ${aboutVisible?"on":""}`}>
            ...
            <p style={{ color:"rgba(255,255,255,.52)", lineHeight:1.8, fontSize:15, marginBottom:14 }}>
              Willkommen bei <strong style={{ color:"#fff" }}>DaheimUmzug</strong>. Wir sind nicht einfach nur ein Transportunternehmen â€” wir sind Ihre pers&ouml;nliche Umzugs-Spezialeinheit in Baden-W&uuml;rttemberg.
            </p>
            <p style={{ color:"rgba(255,255,255,.52)", lineHeight:1.8, fontSize:15, marginBottom:32 }}>
              Mit &uuml;ber 8 Jahren Erfahrung garantieren wir einen reibungslosen Ablauf. Ihre M&ouml;bel sind mehr als Gegenst&auml;nde â€” sie sind Teil Ihrer Geschichte.
            </p>
            <div style={{ display:"flex", flexDirection:"column", gap:13 }}>
              {["Kostenlose Besichtigung vor Ort","Vollkasko-Versicherung inklusive","Profi-Equipment f&uuml;r empfindliche Elektronik"].map((item,i) => (
          ...
          <div className={`about-img-col fu ${aboutVisible?"on":""} d2`} style={{ position:"relative" }}>
            ...
            <div style={{ position:"absolute", bottom:24, left:-16, background:GOLD, borderRadius:16, padding:"14px 20px", boxShadow:`0 12px 32px rgba(176,137,104,.4)` }}>
              <div style={{ fontFamily:"'Playfair Display', serif", fontSize:22, fontWeight:900, color:NAVY, lineHeight:1 }}>4.9â˜…</div>
            ...
            <div className="calc-wrap" style={{ display:"flex" }}>
              ...
              <div className="calc-left" style={{ flex:"0 0 290px", background:"rgba(7,18,34,.6)", padding:"44px 32px", borderRight:"1px solid rgba(176,137,104,.1)", display:"flex", flexDirection:"column", justifyContent:"space-between", gap:28 }}>
                ...
                <div style={{ background:GOLD, borderRadius:20, padding:"26px 22px", textAlign:"center" }}>
                  ...
                  <div style={{ fontFamily:"'Playfair Display', serif", fontSize:"clamp(34px,4vw,46px)", fontWeight:900, fontStyle:"italic", color:NAVY, lineHeight:1 }}>{price} â‚¬</div>
              ...
              <div style={{ flex:1, padding:"44px 32px" }}>
                <div className="calc-fields" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:16, marginBottom:18 }}>
                    ...
                    {distMode==="manual" ? (
                      ...
                      <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                        ...
                        {!addrLoading && !addrError && (!addrFrom.trim()||!addrTo.trim()) && (
                          <p style={{ color:"rgba(255,255,255,.28)", fontSize:11, margin:0 }}>Beide Adressen eingeben â€” Preis passt sich automatisch an.</p>
                        )}
                      </div>
                    )}
                  </div>
                  ...
                  <div style={{ gridColumn:"1 / -1", borderTop:"1px solid rgba(176,137,104,.15)", paddingTop:20, marginTop:4 }}>
                    ...
                    <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:16 }}>
                      ...
                      <Counter label="K&uuml;che abbauen"    priceEach={200} value={kitchenAbbau} onChange={setKitchenAbbau} />

                      {/* K&uuml;che aufbauen toggle */}
                      <div>
                        <div style={{ fontSize:10, fontWeight:700, color:"rgba(255,255,255,0.38)", textTransform:"uppercase", letterSpacing:"0.15em", marginBottom:7, display:"flex", justifyContent:"space-between" }}>
                        ...
                        <button type="button" onClick={() => setKitchenAufbau(v => !v)}
                          ...
                          {kitchenAufbau ? "&#x2713; Gew&uuml;nscht" : "Nicht ben&ouml;tigt"}
                        </button>
                      </div>
                    </div>
                  </div>
                ...
                <div style={{ background:"rgba(176,137,104,.08)", border:"1px solid rgba(176,137,104,.22)", borderRadius:16, padding:"18px 20px", marginBottom:14, display:"flex", alignItems:"center", justifyContent:"space-between", gap:16, flexWrap:"wrap" }}>
                  ...
                  <div style={{ fontFamily:"'Playfair Display', serif", fontSize:26, fontWeight:900, fontStyle:"italic", color:GOLD, whiteSpace:"nowrap" }}>{price} â‚¬</div>
                </div>
                <button type="button" className="gold-btn" onClick={() => scrollTo("kontakt")}>
                  Verbindliches Angebot anfragen â†’
                </button>
              </div>
            </div>
          </div>
        ...
        <div style={{ maxWidth:660, margin:"0 auto" }}>
          ...
          {submitted ? (
            <div style={{ textAlign:"center", padding:"56px 32px", background:NAVY2, borderRadius:28, border:`1px solid ${GOLD}` }}>
              ...
              <p style={{ color:"rgba(255,255,255,.48)", fontSize:14 }}>WhatsApp wurde ge&ouml;ffnet â€” wir melden uns innerhalb von 24 Stunden.</p>
            ...
            <div className={`fu ${contactVisible?"on":""} d2`}
              ...
              <button type="button" className="gold-btn" onClick={handleSubmit}>
                &#x1F4F2; Anfrage per WhatsApp senden â†’
              </button>
              <div style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:18, marginTop:18, flexWrap:"wrap" }}>
                {["&#x1F512; Keine Weitergabe","&#x2713; Kostenlos & unverbindlich","&#x1F550; Antwort in 24h"].map((t,i) => (
                  <span key={i} style={{ fontSize:11, color:"rgba(255,255,255,.28)" }}>{t}</span>
                ))}
              </div>
            </div>
          )}
        ...
        <div className="footer-grid" style={{ maxWidth:1100, margin:"0 auto", display:"grid", gridTemplateColumns:"2fr 1fr 1fr", gap:44, marginBottom:36 }}>
          <div>
            ...
            <p style={{ color:"rgba(255,255,255,.28)", fontSize:13, lineHeight:1.7, maxWidth:260 }}>
              Ihr zuverl&auml;ssiger Umzugspartner in Baden-W&uuml;rttemberg â€” mit Leidenschaft und Sorgfalt.
            </p>
            <div style={{ display:"flex", gap:10, marginTop:18 }}>
              <a href="https://wa.me/49000000000" target="_blank" rel="noopener noreferrer"
                style={{ width:36, height:36, borderRadius:10, background:"#25d366", display:"flex", alignItems:"center", justifyContent:"center", textDecoration:"none", fontSize:16, transition:"opacity .2s" }}
